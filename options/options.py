...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--dir', default='/data/milatmp1/ghadirif/DeepFashion', help='path to the data directory containing Img and annotation')
        ...
        self.parser.add_argument('--checkpoint_name', type=str, default='epoch_7.pth', help='path to pretrained model or model to deploy')
        self.parser.add_argument('--pretrain', action='store_true',default='True', help='default false. If true, load pretrained model to initizaize model state_dict')
        ## for train
        ...
        self.parser.add_argument('--sum_epoch', type=int, default=1, help='sum epoches for training')
